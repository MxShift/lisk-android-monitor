...
/**
 * Created by victorlins on 12/4/16.
 */
...
public class BlocksAdapter extends
    ...
    public void onBindViewHolder(BlocksAdapter.ViewHolder holder, int position) {
        ...
        feeTextView.setText(String.valueOf(Utils.convertToLiskBase(block.getTotalFee())));
        rewardTextView.setText(String.valueOf(Utils.convertToLiskBase(block.getReward())));
    }
