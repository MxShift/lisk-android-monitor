...
public class MainFragment extends Fragment {
            ...
            public void onResponse(final Forging forging) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String rewards = String.valueOf(Utils.convertToLiskBase(forging.getRewards()));
    ...
    private void calculateEquivalentInBitcoinUSDandEUR(){
        if (MainFragment.this != null && MainFragment.this.balance > 0 && MainFragment.this.liskBTCValue > 0) {
